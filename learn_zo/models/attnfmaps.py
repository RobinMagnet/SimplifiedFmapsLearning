...
class PointConvBlock(nn.Module):
    """
    A point convolution block. It consists of a 1x1 convolution, a batch normalization, a ReLU activation, and an
...
class FeatureSTN(nn.Module):
    """
    A feature spatial transformer network. It consists of a 1x1 convolution, a batch normalization, a ReLU activation,
    a max pooling, and a fully-connected layer.
    """
